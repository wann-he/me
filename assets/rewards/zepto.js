...
var Zepto = function () {
    ...
    function h(t) {
        var e, n;
        return Z[t] || (e = A.createElement(t), A.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), Z[t] = n), Z[t]
    }
    ...
    var w, E, j, N, C, T, S = [], O = S.slice, P = S.filter, A = window.document, Z = {}, $ = {}, L = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, _ = /^\s*<(\w+|!)[^>]*>/, D = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, R = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, k = /^(?:body|html)$/i, q = /([A-Z])/g, M = ["val", "css", "html", "text", "data", "width", "height", "offset"], z = ["after", "prepend", "before", "append"], F = A.createElement("table"), H = A.createElement("tr"), I = {
    ...
    return X.matches = function (t, e) {
        ...
        var r, i, s;
        return D.test(t) && (r = j(A.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(R, "<$1></$2>")), e === w && (e = _.test(t) && RegExp.$1), e in I || (e = "*"), s = I[e], s.innerHTML = "" + t, r = j.each(O.call(s.childNodes), function () {
            s.removeChild(this)
        ...
        if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && _.test(t))r = X.fragment(t, RegExp.$1, n), t = null; else {
            ...
            if (X.isZ(t))return t;
            if (G(t))r = a(t); else if (i(t))r = [t], t = null; else if (_.test(t))r = X.fragment(t.trim(), RegExp.$1, n), t = null; else {
                if (n !== w)return j(n).find(t);
                r = X.qsa(A, t)
            }
        }
        ...
        return r(t) && a && i ? (n = t.getElementById(s)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : O.call(a && !i ? o ? t.getElementsByClassName(s) : t.getElementsByTagName(e) : t.querySelectorAll(e))
        ...
        not: function (t) {
            ...
            if (e(t) && t.call !== w)this.each(function (e) {
                ...
                var r = "string" == typeof t ? this.filter(t) : s(t) && e(t.item) ? O.call(t) : j(t);
            ...
            return t ? this.each(function (e) {
                if ("className"in this) {
                    ...
                    r.split(/\s+/g).forEach(function (t) {
                        j(this).hasClass(t) || N.push(t)
                    }, this), N.length && y(this, n + (n ? " " : "") + N.join(" "))
                }
            }) : this
        },
        removeClass: function (t) {
            return this.each(function (e) {
                if ("className"in this) {
                    ...
                    N = y(this), v(this, t, e, N).split(/\s+/g).forEach(function (t) {
                        N = N.replace(l(t), " ")
                    }), y(this, N.trim())
                }
            })
        ...
        j.fn[e] = function () {
            ...
            return 1 > o.length ? this : this.each(function (t, e) {
                ...
                var a = j.contains(A.documentElement, i);
                o.forEach(function (t) {
                    if (s)t = t.cloneNode(!0); else if (!i)return j(t).remove();
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    var m, v, g = 0, y = window.document, x = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, b = /^(?:text|application)\/javascript/i, w = /^(?:text|application)\/xml/i, E = "application/json", j = "text/html", N = /^\s*$/;
    t.active = 0, t.ajaxJSONP = function (e, n) {
        ...
        if (w.setRequestHeader = x, w.onreadystatechange = function () {
                if (4 == w.readyState) {
                    ...
                    if (w.status >= 200 && 300 > w.status || 304 == w.status || 0 == w.status && "file:" == b) {
                        ...
                        try {
                            "script" == u ? (1, eval)(e) : "xml" == u ? e = w.responseXML : "json" == u && (e = N.test(e) ? null : t.parseJSON(e))
                        } catch (o) {
                            r = o
                        }
                        r ? a(r, "parsererror", w, n, i) : s(e, w, n, i)
                    } else a(w.statusText || null, w.status ? "error" : "abort", w, n, i)
                }
            }, o(w, n) === !1)return w.abort(), a(null, "abort", w, n, i), w;
        ...
        return n.timeout > 0 && (d = setTimeout(function () {
            w.onreadystatechange = c, w.abort(), a(null, "timeout", w, n, i)
    ...
    function c(e, n) {
        return (n || !e.isDefaultPrevented) && (n || (n = e), t.each(N, function (t, r) {
            var i = n[t];
            e[t] = function () {
    ...
    t.fn.delegate = function (t, e, n) {
        ...
        return e && !m(e) ? (t.each(e, function (t, e) {
            ...
            o && (s = function (t) {
                ...
                return o && o !== d ? (r = t.extend(l(e), {
                    currentTarget: o,
                    liveFired: d
                }), (s || i).apply(o, [r].concat(p.call(arguments, 1)))) : f
            }), a(d, e, i, r, n, c || s)
        }))
        ...
        return this.each(function (s, a) {
            i = l(m(e) ? t.Event(e) : e), i._args = r, i.target = a, t.each(n(a, e.type || e), function (t, e) {
                return o = e.proxy(i), i.isImmediatePropagationStopped() ? !1 : f
            })
        }), o
    ...
    }, a = RegExp("(.*):(\\w+)(?:\\(([^)]+)\\))?$\\s*"), u = /^\s*>/, c = "Zepto" + +new Date;
    r.qsa = function (e, o) {
