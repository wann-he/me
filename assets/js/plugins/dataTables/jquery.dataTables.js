...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param {object} oSettings dataTables settings object
	 *  @param {boolean} [holdPosition] Keep the current paging.vm position. By default
	 *    the paging.vm is reset to the first page
	 *  @memberof DataTable#oApi
	 */
	...
	/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 * Note that most of the paging.vm logic is done in
	 * DataTable.ext.pager
	 */
	...
	function _fnFeatureHtmlPaginate ( settings )
	{
		...
		/* Add a draw callback for the pagination on first instance, to update the paging.vm display */
		if ( ! features.p )
		{
	...
	function _fnPageChange ( settings, action, redraw )
	{
		...
		{
			_fnLog( settings, 0, "Unknown paging.vm action: "+action, 5 );
		}
	 ...
	 *
	 * @param {boolean} [reset=true] Reset (default) or hold the current paging.vm
	 ...
	 * not throw an error, but rather reset the paging.vm.
	 *
	 * @param {integer|string} action The paging.vm action to take. This can be one of:
	 ...
	 *
	 * If you require paging.vm information for another table, use the `table()` method
	...
	DataTable.defaults = {
		 ...
		 *
		 *  @dtopt Features
		 *  @name DataTable.defaults.paging.vm
		 *
		 *  @example
		 *    $(document).ready( function () {
		 *      $('#example').dataTable( {
		...
		/**
		 * By default DataTables allows keyboard navigation of the table (sorting, paging.vm,
		 ...
		 * current viewport. This can be used as an alternative to paging.vm to display
		 * a lot of data in a small area (although paging.vm and scrolling can both be
		 ...
		 * integration plug-in for DataTables uses a paging.vm button renderer to
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			 ...
			 * sorting or paging.vm done on the client-side.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
			 */
	...
	$.extend( DataTable.ext.oJUIClasses, DataTable.ext.classes, {
		/* Full numbers paging.vm buttons */
	...
	/**
	 * Page change event, fired when the paging.vm of the table is altered.
